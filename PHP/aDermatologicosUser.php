...
$cadena         ="SELECT * FROM adermatologicos";
...
<head>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="aDermatologicosUser.php"class="active" >A.Dermatologicos</a></li>
        ...
        <div class="section">
            ...
            <br><br>
            <h1>Antecedentes Dermatologicos</h1>
        </div>

        <div class="textbox">
            P1.-¿Cuál es el espesor de la piel? <br>
            P2.-¿El espesor de la piel es uniforme en todo el cuerpo? <br>
            P3.-¿En que parte del cuerpo tiene afectaciones? <br>
            P4.-¿Con qué frecuencia lava la zona afectada? <br>
