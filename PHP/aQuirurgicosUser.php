...
$cadena         ="SELECT * FROM aquirurjicos";
...
<head>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="aQuirurgicosUser.php"class="active" >A.Quirurgicos</a></li>            
        ...
        <div class="textbox">
            P1.-¿Ha tenido alguna intervención quirúrgica? <br>
            P2.-¿Qué tipo de intervención ?<br>
            P3.-¿Hace cuánto tiempo fue?<br>
            P4.-¿Tuvo alguna complicación?<br>
