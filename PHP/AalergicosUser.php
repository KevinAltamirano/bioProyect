...
<head>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="AalergicosUser.php"class="active" >A.Alergicos</a></li>
        ...
        <div class="section">
            ...
            <br><br>
            <h1>Antecedentes Alergicos</h1>
        </div>

        <div class="textbox">
            P1.-¿Cuál es la frecuencia o gravedad de los síntomas? <br>
            P2¿Los síntomas son estacionales o continuos?<br>
            P3.-¿Existen factores desencadenantes (alérgicos o no alérgicos)?<br>
            P4.-¿Existe algún posible alérgeno existente en tu domicilio?<br>
            P5.-¿Alguna reacción alérgica alimentaria o reacción adversa ?<br>
            P6.-¿Existe alguien en tu familia con asma?<br>
            P7.-¿Existe alguien en tu familia con rinitis?<br>
            P8.-¿Te han tratado antes sobre alergias?<br>
            P9.-¿Tienes contacto con animales?<br>
        </div>
