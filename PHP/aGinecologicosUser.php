...
$cadena         ="SELECT * FROM aginecologicos";
...
<head>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="aGinecologicosUser.php" class="active" >A.Ginecologicos</a></li> 
        ...
        <div class="textbox">
            P1.-¿Cuándo fue su primera menstruación? <br>
            P2.-¿A qué edad dejo de menstruar?<br>
            P3.-¿Cuánto dura su regla?<br>
            P4.-¿Presenta dolor durante estos días?<br>
            P5.-¿Qué tan abundante es?<br>
            P6.-¿Existe la presencia de otros flujos vaginales?<br>
            P7.-¿Cuantos embarazos ha tenido?<br>
            P8.-¿El parto fue vaginal o mediante operación?<br>
            P9.-¿Ha tenido algún aborto?<br>
            P10.-¿Que métodos anticonceptivos utiliza?<br>
            P11.-Información sobre enfermedades o procedimientos ginecológicos<br>
            P12.-¿Fecha de ultima citología vaginal, mamografía?<br>
