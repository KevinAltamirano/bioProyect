...
$cadena         ="SELECT * FROM psicosexual";
...
<head>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="psicosexualUser.php"class="active"  >Psicosexual</a></li>
        ...
        <div class="textbox">
            ...
            P1.-¿Vida sexual activa? <br>
            P2.-¿Número de parejas?<br>
            P3.-¿Relaciones homosexuales?<br>
            P4.-¿Relaciones extramaritales?<br>
